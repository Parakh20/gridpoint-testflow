...
export function ProjectStatusActions({ project, onStatusChange }: ProjectStatusActionsProps) {
  ...
  const updateProjectStatus = async (newStatus: string, additionalFields: any = {}) => {
    setLoading(true);
    try {
  ...
  const handleActivate = async () => {
    // Check if equipment instances exist
    ...
    switch (dialogAction) {
      case 'approve':
        return {
          ...
          description: 'Are you sure you want to approve this test plan? This will allow the project to be activated.',
        };
      case 'activate':
        return {
          title: 'Activate Project',
          description: 'Are you sure you want to activate this project? Field work can begin after activation.',
        };
      case 'close':
        return {
          title: 'Close Project',
          description: 'Are you sure you want to close this project? This action marks the project as completed.',
        };
      case 'revert':
        return {
          title: 'Revert to Draft',
          description: 'Are you sure you want to revert this project to draft status? Approval information will be removed.',
        };
      case 'delete':
        return {
