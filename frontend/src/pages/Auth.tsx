...
export default function Auth() {
  ...
  const { signIn, signInWithGoogle, resetPasswordForEmail, updatePassword, companyMismatch, accountDisabled, oauthPending } = useAuth();
              ...
              {(
                <>
                  ...
                  <button
                    ...
                    className="mt-3 w-full flex items-center justify-center gap-2.5 h-11 rounded-lg border border-border bg-card hover:bg-accent transition text-sm font-medium text-foreground disabled:opacity-60"
                  >
                    {googleLoading ? (
